const Map<String, String> ar = {
  ...
  'Your Balance':'رصيدك',
  'Purchase consulting credits and consult more with our packages':'اشتري رصيد لللإستشارة واستشر اكثر مع باقاتنا',
  ...
  'You can search a doctor and book an appointment':'يمكنك البحث عن طبيب وحجز موعد',
  'Welcome, ':'مرحباً ,',
  ...
  'video/phone consult top doctors from your home/office/car : 24/7':'استشر أفضل الأطباء عبر الفيديو من منزلك /مكتبك/سيارتك 24/7',
  'Book the best doctors from multi specialist':'احجز موعر مع أفضل الأطباء من جميع الاختصاصات',
  ...
  'لا يوجد طبيب مسجل في هذه الفئة',
  'Price': 'السعر',
  ...
  'You cant book this duration,not enough time':'لايوجد وقت كاف لحجز هذه المدة',
  'Login': 'تسجيل الدخول',
  'Review Doctor': 'اكتب مراجعة للطبيب',
  'Your Review': 'مراجعتك',
  'Please wait for remote user to join': 'الرجاء انتظار المستخدم البعيد للانضمام',
